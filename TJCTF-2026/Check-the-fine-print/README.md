...
```
Các byte này chính là byte 00 và 01 nằm sau 08 02 --> Đó là trường Compression method
...
```
Compression method = 00 -> bit 0
Compression method = 01 -> bit 1
```
Ghép 8 bit đầu 
```
01110100
```
Đổi sang ASCII 01110100 = 0x74 -> t

8 bit tiếp theo lần lượt ra chữ 'j', 'c',..

Ta thấy chuẩn định dạng cờ tjctf{...}
